 ...
 * @retval VECTOR_UNITIALIZED_ERROR in case that _vector or _item is NULL
 * @retval VECTOR_OVERRFLOW in case that the _initialCapacity is equal to the number of elements and _blockSize is equal to 0
 * @retval VECTOR_ALLOCATION_ERROR in case that the dynamic allocation falied
 */
 ...
 * @return success or error code 
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNITIALIZED_ERROR in case that _vector or _pValue is NULL
 * @retval VECTOR_UNDERFLOW in case that _vector is empty
 ...
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNITIALIZED_ERROR in case that _vector or _pValue is NULL
 * @retval VECTOR_INDEX_OUT_OF_BOUNDS_ERROR in case that _index is out of range
 */
 ...
 * @return success or error code 
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNITIALIZED_ERROR in case that _vector or _value is NULL
 * @retval VECTOR_INDEX_OUT_OF_BOUNDS_ERROR in case that _index is out of range
 */
 ...
 * @returns the index we stopped at/number of elements (and not the number of times the user functions was invoked)
 * equevallent to:
